    ...
    async with stdio_client(server_params) as (read, write):
        async with ClientSession(read, write) as session:
            ...
            for t in tools.tools:
                logger.info("Tool available", extra={"name": t.name, "description": t.description})
            ...
            logger.info("lookupCustomerByPhone result", extra=data)
            ...
            logger.info("searchTours result", extra={"tour_count": len(tours)})
            ...
            chosen = tours[0]
            logger.info("Chosen tour", extra=chosen)
            ...
            logger.info("bookTour result", extra=booking_resp)
